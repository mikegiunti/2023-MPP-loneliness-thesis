...
qui svy: xtmlogit happy lonely intcntct intcntctlonely partvol marcohab occ10STEM attend i.year if include_sample == 1, fe
testparm i.year
...
*Connectivity
qui xtmlogit happy lonely intcntct intcntctlonely partvol marcohab occ10STEM attend i.year if include_sample == 1, fe
estimates store fixed_intcntct

qui xtmlogit happy lonely intcntct intcntctlonely partvol marcohab occ10STEM attend i.year if REinclude_sample == 1
...
qui svy: xtmlogit happy lonely cohesion cohesionlonely partpartoffline partpartonline if include_sample == 1, fe
...
svy: xtmlogit happy ib2.lonely intcntct ib2.intcntctlonely partvol marcohab occ10STEM attend i.year if include_sample == 1, fe
...
qui svy: xtmlogit happy ib2.lonely intcntct ib2.intcntctlonely partvol marcohab occ10STEM attend i.year if include_sample == 1, fe rrr
...
qui svy: xtmlogit happy2 lonely intcntct intcntctlonely partvol marcohab occ10STEM attend i.year if include_sample2 == 1, fe
testparm i.year
...
svy: xtmlogit happy2 ib2.lonely intcntct ib2.intcntctlonely partvol marcohab occ10STEM attend i.year if include_sample2 == 1, fe
...
qui svy: xtmlogit happy2 ib2.lonely intcntct ib2.intcntctlonely partvol marcohab occ10STEM attend i.year if include_sample == 1, fe rrr
estimates store model_intcntct_rrr2

qui svy: xtmlogit happy2 ib2.lonely cohesion ib2.cohesionlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_sample == 1, fe
