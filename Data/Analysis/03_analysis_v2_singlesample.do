...
qui svy: xtmlogit happy ib2.lonely intcntct intcntctlonely partvol marcohab occ10STEM attend i.year, fe
...
qui svy: xtmlogit happy lonely intcntct intcntctlonely partvol marcohab occ10STEM attend i.year
...
qui svy: xtmlogit happy lonely intcntct intcntctlonely partvol marcohab occ10STEM attend i.year if include_intcntct == 1, fe
testparm i.year
scalar F_time_intcntct = r(F)
scalar p_time_intcntct = r(p)

qui svy: xtmlogit happy lonely cohesion cohesionlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_cohesion == 1, fe
testparm i.year
...
*Connectivity
qui xtmlogit happy lonely intcntct intcntctlonely partvol marcohab occ10STEM attend i.year if include_intcntct == 1, fe
estimates store fixed_intcntct

qui xtmlogit happy lonely intcntct intcntctlonely partvol marcohab occ10STEM attend i.year if REinclude_intcntct == 1
...
*Cohesion
qui xtmlogit happy lonely cohesion cohesionlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_cohesion == 1, fe
estimates store fixed_cohesion

qui xtmlogit happy lonely cohesion cohesionlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if REinclude_cohesion == 1
...
svy: xtmlogit happy ib2.lonely cohesion ib2.cohesionlonely partpartoffline partpartonline if include_cohesion == 1, fe
...
svy: xtmlogit happy ib2.lonely intcntct ib2.intcntctlonely partvol marcohab occ10STEM attend i.year if include_intcntct == 1, fe
...
svy: xtmlogit happy ib2.lonely cohesion ib2.cohesionlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_cohesion == 1, fe
...
*PART 9: Tables
*Part 9.1: Descriptives Loneliness
tabout lonely happy intcntct occ10STEM year using LonelinessDescriptives.tex if include_sample == 1, replace style(tex) font(bold) twidth(12) c(col) bt svy f(3) npos(col) dropc(4) h1(Year) h2c(2 2 1) ptotal(none) nlab(Total) title(Table 1: Loneliness and Connectivity Descriptive Statistics (Fixed Effects)) fn(\textbf{Note:} Sample values are based on the total sample size after the controlled regression (N = 290). Cell numbers indicate the proportion of participants per category per year, while the \emph{total} column indicates the total number of participants within each category across both years. These variables are used as the main regressors in the model.)

*Part 9.2: Descriptives Cohesion
tabout cohesion partpartoffline partpartonline year using CohesionDescriptives.tex if include_sample == 1, replace style(tex) font(bold) twidth(12) c(col) bt svy f(3) npos(col) dropc(4) h1(Year) h2c(2 2 1) ptotal(none) nlab(Total) title(Table 2: Behavioral Descriptives of Survey Participants (Fixed Effects)) fn(\textbf{Note:} Sample values are based on the total sample size after the controlled regression (N = 290). Cell numbers indicate the proportion of participants per category per year, while the \emph{total} column indicates the total number of participants within each category across both years. It is assumed that these variables will mediate the effect of our main regressors on happiness.)

*Part 9.3: Descriptives Demographics
tabout agecat race region4 attend4 using DemographicDescriptives.tex if include_sample == 1, replace style(tex) font(bold) twidth(10) c(col se) f(1p 2) mult(100) h1(Stratified Sample) bt oneway svy ptotal(none) noobs title(Table 3: Demographic Statistics of Survey Participants (Fixed Effects)) fn(\textbf{Note:} Sample values are based on the total sample size after the controlled regression (N = 290). These numbers reflect the participants that were used in the regression sample, and did not drop due to either missingness or lack of variance across survey years.)

*Part 9.4: Model Comparison

*v1
esttab model_intcntct model_cohesion using Model.tex, replace style(tex) booktabs b(3) se(2) varwidth(30) modelwidth(5) legend nobaselevels noomitted unstack lines compress nogaps nonumber order(intcntct 1.intcntctlonely 3.intcntctlonely cohesion 1.cohesionlonely 3.cohesionlonely 1.lonely 3.lonely partpartonline partpartoffline partvol marcohab occ10STEM attend 2.year) indicate("Time Effects = *.year") scalars("N_pop Individuals" "F F-Statistic" "p p-value" "à \hline \textbf{Hausman Test Results}" "chi_haus Hausman \chi^2" "p_haus Hausman p-value" "è \hline \textbf{Time Effect Test}" "F_time \texorpdfstring{F-value\textsubscript{time}}" "p_time \texorpdfstring{p-value\textsubscript{time}}") title("\textbf{Multinomial Logistic Models Connectivity Vs. Social Cohesion Proxy} \strut"\label{tab2}) refcat(intcntct "\textbf{Interaction Effects:}" 1.lonely "\midrule \textbf{Main Loneliness Effect:}" partvol "\textbf{Controls:}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" cohesion "\hspace{0.25cm} High Social Cohesion" intcntct "\hspace{0.25cm} High Online Communication" partpartonline "\hspace{0.25cm} Online Engagement" partpartoffline "\hspace{0.25cm} Offline Engagement" partvol "\hspace{0.25cm} Volunteering" marcohab "\hspace{0.25cm} Marriage Status" occ10STEM "\hspace{0.25cm} Online Workspace" attend "\hspace{0.25cm} Religious Activity" 2.year "Year" 1.intcntctlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.intcntctlonely "\hspace{0.5cm} \emph{w/High Loneliness}" 1.cohesionlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.cohesionlonely "\hspace{0.5cm} \emph{w/High Loneliness}")  mtitles("\underline{Online Communication}" "\underline{Social Cohesion}") eqlabels("Happy" "Unhappy") sfmt(%9.0fc %9.2fc %9.3fc %9.2fc %9.3fc) star(^+ 0.10 * 0.05 ** 0.01) label

*v2
esttab model_intcntct model_cohesion model_cohesion_base using Modelv2.tex, replace style(tex) booktabs b(3) se(2) varwidth(30) modelwidth(5) legend nobaselevels noomitted unstack lines compress nogaps nonumber order(intcntct 1.intcntctlonely 3.intcntctlonely cohesion 1.cohesionlonely 3.cohesionlonely 1.lonely 3.lonely partpartonline partpartoffline partvol marcohab occ10STEM attend 2.year) indicate("Time Effects = *.year") scalars("N_pop Individuals" "F F-Statistic" "p p-value" "à \hline \textbf{Hausman Test Results}" "chi_haus Hausman \chi^2" "p_haus Hausman p-value" "è \hline \textbf{Time Effect Test}" "F_time \texorpdfstring{F-value\textsubscript{time}}" "p_time \texorpdfstring{p-value\textsubscript{time}}") title("\textbf{Multinomial Logistic Models Connectivity Vs. Social Cohesion Proxy} \strut"\label{tab2}) refcat(intcntct "\textbf{Interaction Effects:}" 1.lonely "\midrule \textbf{Main Loneliness Effect:}" partvol "\textbf{Controls:}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" cohesion "\hspace{0.25cm} High Social Cohesion" intcntct "\hspace{0.25cm} High Online Communication" partpartonline "\hspace{0.25cm} Online Engagement" partpartoffline "\hspace{0.25cm} Offline Engagement" partvol "\hspace{0.25cm} Volunteering" marcohab "\hspace{0.25cm} Marriage Status" occ10STEM "\hspace{0.25cm} Online Workspace" attend "\hspace{0.25cm} Religious Activity" 2.year "Year" 1.intcntctlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.intcntctlonely "\hspace{0.5cm} \emph{w/High Loneliness}" 1.cohesionlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.cohesionlonely "\hspace{0.5cm} \emph{w/High Loneliness}") mgroups("w/Controls" "Base", pattern(1 0 1) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) mtitles("\underline{Online Communication}" "\underline{Social Cohesion}" "\underline{Social Cohesion}") eqlabels("Happy" "Unhappy") sfmt(%9.0fc %9.2fc %9.3fc %9.2fc %9.3fc) star(^+ 0.10 * 0.05 ** 0.01) label


*Part 9.5: Relative Risk Ratio Table
qui svy: xtmlogit happy ib2.lonely intcntct ib2.intcntctlonely partvol marcohab occ10STEM attend i.year if include_intcntct == 1, fe rrr
estimates store model_intcntct_rrr

qui svy: xtmlogit happy ib2.lonely cohesion ib2.cohesionlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_cohesion == 1, fe
estimates store model_cohesion_rrr

esttab model_intcntct_rrr model_cohesion_rrr using RRR1.tex, replace style(tex) eform booktabs varwidth(30) modelwidth(10) legend nobaselevels noomitted unstack lines compress nogaps b(a3) not nose noomitted order(intcntct 1.intcntctlonely 3.intcntctlonely cohesion 1.cohesionlonely 3.cohesionlonely 1.lonely 3.lonely partpartonline partpartoffline partvol marcohab occ10STEM attend 2.year) scalars("N_pop Individuals") title("\textbf{Multinomial Logistic Models Connectivity Vs. Social Cohesion Proxy} \strut"\label{tab2}) refcat(intcntct "\textbf{Interaction Effects:}" 1.lonely "\midrule \textbf{Main Loneliness Effect:}" partvol "\textbf{Controls:}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" cohesion "\hspace{0.25cm} High Social Cohesion" intcntct "\hspace{0.25cm} High Online Communication" partpartonline "\hspace{0.25cm} Online Engagement" partpartoffline "\hspace{0.25cm} Offline Engagement" partvol "\hspace{0.25cm} Volunteering" marcohab "\hspace{0.25cm} Marriage Status" occ10STEM "\hspace{0.25cm} Online Workspace" attend "\hspace{0.25cm} Religious Activity" 2.year "Year" 1.intcntctlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.intcntctlonely "\hspace{0.5cm} \emph{w/High Loneliness}" 1.cohesionlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.cohesionlonely "\hspace{0.5cm} \emph{w/High Loneliness}") mtitles("\underline{Online Communication}" "\underline{Social Cohesion}" "\underline{Social Cohesion}") eqlabels("Happy" "Unhappy") sfmt(%9.0fc %9.2fc %9.3fc %9.2fc %9.3fc) star(^+ 0.10 * 0.05 ** 0.01) label drop(2.year attend occ10STEM marcohab partvol)
...
qui svy: xtmlogit happy2 ib2.lonely intcntct intcntctlonely partvol marcohab occ10STEM attend i.year, fe
...
qui svy: xtmlogit happy2 lonely intcntct intcntctlonely partvol marcohab occ10STEM attend i.year if include_intcntct2 == 1, fe
testparm i.year
scalar F_time_intcntct2 = r(F)
scalar p_time_intcntct2 = r(p)

qui svy: xtmlogit happy2 lonely cohesion cohesionlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_cohesion2 == 1, fe
testparm i.year
...
qui svy: xtmlogit happy2 lonely cohesion cohesionlonely partpartoffline partpartonline if include_cohesion2 == 1, fe
scalar F_cohesion_base2 = e(F)
scalar p_cohesion_base2 = e(p)
*******************************************************************************************************************
svy: xtmlogit happy2 ib2.lonely cohesion ib2.cohesionlonely partpartoffline partpartonline if include_cohesion2 == 1, fe
estimates store model_cohesion_base2
estadd scalar F = F_cohesion_base2, replace
estadd scalar p = p_cohesion_base2, replace

svy: xtmlogit happy2 ib2.lonely intcntct ib2.intcntctlonely partvol marcohab occ10STEM attend i.year if include_intcntct2 == 1, fe
...
svy: xtmlogit happy2 ib2.lonely cohesion ib2.cohesionlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_cohesion2 == 1, fe
...
*v1
esttab model_intcntct2 model_cohesion2 using Model_althap.tex, replace style(tex) booktabs b(3) se(2) varwidth(30) modelwidth(5) legend nobaselevels noomitted unstack lines compress nogaps nonumber order(intcntct 1.intcntctlonely 3.intcntctlonely cohesion 1.cohesionlonely 3.cohesionlonely 1.lonely 3.lonely partpartonline partpartoffline partvol marcohab occ10STEM attend 2.year) indicate("Time Effects = *.year") scalars("N_pop Individuals" "F F-Statistic" "p p-value" "è \hline \textbf{Time Effect Test}" "F_time \texorpdfstring{F-value\textsubscript{time}}" "p_time \texorpdfstring{p-value\textsubscript{time}}") title("\textbf{Multinomial Logistic Models Connectivity Vs. Social Cohesion Proxy} \strut"\label{tab2}) refcat(intcntct "\textbf{Interaction Effects:}" 1.lonely "\midrule \textbf{Main Loneliness Effect:}" partvol "\textbf{Controls:}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" cohesion "\hspace{0.25cm} High Social Cohesion" intcntct "\hspace{0.25cm} High Online Communication" partpartonline "\hspace{0.25cm} Online Engagement" partpartoffline "\hspace{0.25cm} Offline Engagement" partvol "\hspace{0.25cm} Volunteering" marcohab "\hspace{0.25cm} Marriage Status" occ10STEM "\hspace{0.25cm} Online Workspace" attend "\hspace{0.25cm} Religious Activity" 2.year "Year" 1.intcntctlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.intcntctlonely "\hspace{0.5cm} \emph{w/High Loneliness}" 1.cohesionlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.cohesionlonely "\hspace{0.5cm} \emph{w/High Loneliness}")  mtitles("\underline{Online Communication}" "\underline{Social Cohesion}") eqlabels("Happy" "Unhappy") sfmt(%9.0fc %9.2fc %9.3fc %9.2fc %9.3fc) star(^+ 0.10 * 0.05 ** 0.01) label

*v2
esttab model_intcntct2 model_cohesion2 model_cohesion_base2 using Modelv2_althap.tex, replace style(tex) booktabs b(3) se(2) varwidth(30) modelwidth(5) legend nobaselevels noomitted unstack lines compress nogaps nonumber order(intcntct 1.intcntctlonely 3.intcntctlonely cohesion 1.cohesionlonely 3.cohesionlonely 1.lonely 3.lonely partpartonline partpartoffline partvol marcohab occ10STEM attend 2.year) indicate("Time Effects = *.year") scalars("N_pop Individuals" "F F-Statistic" "p p-value" "è \hline \textbf{Time Effect Test}" "F_time \texorpdfstring{F-value\textsubscript{time}}" "p_time \texorpdfstring{p-value\textsubscript{time}}") title("\textbf{Multinomial Logistic Models Connectivity Vs. Social Cohesion Proxy} \strut"\label{tab2}) refcat(intcntct "\textbf{Interaction Effects:}" 1.lonely "\midrule \textbf{Main Loneliness Effect:}" partvol "\textbf{Controls:}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" cohesion "\hspace{0.25cm} High Social Cohesion" intcntct "\hspace{0.25cm} High Online Communication" partpartonline "\hspace{0.25cm} Online Engagement" partpartoffline "\hspace{0.25cm} Offline Engagement" partvol "\hspace{0.25cm} Volunteering" marcohab "\hspace{0.25cm} Marriage Status" occ10STEM "\hspace{0.25cm} Online Workspace" attend "\hspace{0.25cm} Religious Activity" 2.year "Year" 1.intcntctlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.intcntctlonely "\hspace{0.5cm} \emph{w/High Loneliness}" 1.cohesionlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.cohesionlonely "\hspace{0.5cm} \emph{w/High Loneliness}") mgroups("w/Controls" "Base", pattern(1 0 1) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) mtitles("\underline{Online Communication}" "\underline{Social Cohesion}" "\underline{Social Cohesion}") eqlabels("Happy" "Unhappy") sfmt(%9.0fc %9.2fc %9.3fc %9.2fc %9.3fc) star(^+ 0.10 * 0.05 ** 0.01) label

*Part 10.4: Relative Risk Ratio Table (alternate)
qui svy: xtmlogit happy2 ib2.lonely intcntct ib2.intcntctlonely partvol marcohab occ10STEM attend i.year if include_intcntct == 1, fe rrr
estimates store model_intcntct_rrr2

qui svy: xtmlogit happy2 ib2.lonely cohesion ib2.cohesionlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_cohesion == 1, fe
