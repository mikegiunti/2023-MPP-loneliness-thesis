...
qui svy: xtmlogit happy lonely intcntct intcntctlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_intcntct == 1, fe
testparm i.year
...
*Connectivity
qui xtmlogit happy lonely intcntct intcntctlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_intcntct == 1, fe
estimates store fixed_intcntct

qui xtmlogit happy lonely intcntct intcntctlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if REinclude_intcntct == 1
...
svy: xtmlogit happy lonely cohesion cohesionlonely partpartoffline partpartonline if include_cohesion == 1, fe
...
svy: xtmlogit happy ib2.lonely intcntct ib2.intcntctlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_intcntct == 1, fe
...
qui svy: xtmlogit happy ib2.lonely intcntct ib2.intcntctlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_intcntct == 1, fe rrr
...
qui svy: xtmlogit happy2 lonely intcntct intcntctlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_intcntct2 == 1, fe
testparm i.year
...
svy: xtmlogit happy2 ib2.lonely intcntct ib2.intcntctlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_intcntct2 == 1, fe
...
*v1
esttab model_intcntct2 model_cohesion2 using Model.tex, replace style(tex) booktabs b(3) se(2) varwidth(30) modelwidth(5) legend nobaselevels noomitted unstack lines compress nogaps nonumber order(intcntct 1.intcntctlonely 3.intcntctlonely cohesion 1.cohesionlonely 3.cohesionlonely 1.lonely 3.lonely partpartonline partpartoffline partvol marcohab occ10STEM attend 2.year) indicate("Time Effects = *.year") scalars("N_pop Individuals" "F F-Statistic" "p p-value" "à \hline \textbf{Hausman Test Results}" "chi_haus Hausman \chi^2" "p_haus Hausman p-value" "è \hline \textbf{Time Effect Test}" "F_time \texorpdfstring{F-value\textsubscript{time}}" "p_time \texorpdfstring{p-value\textsubscript{time}}") title("\textbf{Multinomial Logistic Models Connectivity Vs. Social Cohesion Proxy} \strut"\label{tab2}) refcat(intcntct "\textbf{Interaction Effects:}" 1.lonely "\midrule \textbf{Main Loneliness Effect:}" partvol "\textbf{Controls:}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" cohesion "\hspace{0.25cm} High Social Cohesion" intcntct "\hspace{0.25cm} High Online Communication" partpartonline "\hspace{0.25cm} Online Engagement" partpartoffline "\hspace{0.25cm} Offline Engagement" partvol "\hspace{0.25cm} Volunteering" marcohab "\hspace{0.25cm} Marriage Status" occ10STEM "\hspace{0.25cm} Online Workspace" attend "\hspace{0.25cm} Religious Activity" 2.year "Year" 1.intcntctlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.intcntctlonely "\hspace{0.5cm} \emph{w/High Loneliness}" 1.cohesionlonely "\hspace{0.5cm} \emph{w/Low Loneliness}" 3.cohesionlonely "\hspace{0.5cm} \emph{w/High Loneliness}")  mtitles("\underline{Online Communication}" "\underline{Social Cohesion}") eqlabels("Happy" "Unhappy") sfmt(%9.0fc %9.2fc %9.3fc %9.2fc %9.3fc) star(^+ 0.10 * 0.05 ** 0.01) label
...
qui svy: xtmlogit happy2 ib2.lonely intcntct ib2.intcntctlonely partpartoffline partpartonline partvol marcohab occ10STEM attend i.year if include_intcntct == 1, fe rrr
