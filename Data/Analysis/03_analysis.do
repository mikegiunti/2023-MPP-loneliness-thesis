...
gen cohesion_b = cohesion
recode cohesion (1 = 1) (2 3 = 2) (4 = 3)
label define cohesion1 1 "Not Fair, Not Helpful, Not Trustworthy" 2 "Either Fair, Helpful or Trustworthy" 3 "Fair, Helpful, and Trustworthy"
...
qui svy: xtmlogit happy ib2.lonely intcntct partpartoffline ib2.cohesion i.year if fe_include == 1, fe
estimates store offline_happy_fe

qui svy: xtmlogit happy ib2.lonely intcntct partpartoffline ib2.cohesion partvol marcohab occ10STEM attend i.year if fe_include == 1, fe
estimates store offline_happy_control_fe


qui svy: xtmlogit happy ib2.lonely intcntct partpartonline ib2.cohesion i.year if fe_include == 1, fe
estimates store online_happy_fe

qui svy: xtmlogit happy ib2.lonely intcntct partpartonline ib2.cohesion partvol marcohab occ10STEM attend i.year if fe_include == 1, fe
estimates store online_happy_control_fe


*PART 8: Random Effects Models
svy: xtmlogit happy ib2.lonely intcntct partpartonline ib2.cohesion partvol marcohab occ10STEM attend i.year
...
qui svy: xtmlogit happy ib2.lonely intcntct partpartoffline ib2.cohesion i.year if re_include == 1
estimates store offline_happy_re

qui svy: xtmlogit happy ib2.lonely intcntct partpartoffline ib2.cohesion partvol marcohab occ10STEM attend i.year if re_include == 1
estimates store offline_happy_control_re

qui svy: xtmlogit happy ib2.lonely intcntct partpartonline ib2.cohesion i.year if re_include == 1
estimates store online_happy_re

qui svy: xtmlogit happy ib2.lonely intcntct partpartonline ib2.cohesion partvol marcohab occ10STEM attend i.year if re_include == 1
...
tabout cohesion partpartoffline partpartonline occ10STEM year using TechFE.tex if fe_include == 1, replace style(tex) font(bold) twidth(12) c(col) bt svy f(3) npos(col) dropc(4) h1(Year) h2c(2 2 1) ptotal(none) nlab(Total) title(Table 3: Behavioral Descriptives of Survey Participants (Fixed Effects)) fn(\textbf{Note:} Sample values are based on the total sample size after the controlled regression (N = 276). Cell numbers indicate the proportion of participants per category per year, while the \emph{total} column indicates the total number of participants within each category across both years. It is assumed that these variables will mediate the effect of our main regressors on happiness.)

*PART 10: Table with main effect, RE and FE

esttab base_happy_fe base_happy_dummy_fe base_happy_re base_happy_dummy_re using TimeEffectREFE.tex, replace booktabs b(3) se(2) coeflabels(1.lonely "Low Loneliness" 3.lonely "High Loneliness" 2.year "Year") varwidth(30) modelwidth(5) legend nobaselevels noomitted unstack lines compress nogaps title("\textbf{Comparison of Fixed and Random Effects Loneliness Models} \strut" \label{tab1}) mgroups("Fixed Effects" "Random Effects", pattern(1 0 1 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) nomtitles eqlabels("Happy" "Unhappy") nonumber addnote("\textbf{Note:} the results provided here indicate the need for a time effect control to be utilized with the main model." "In addition, the Hausman test shows that the Fixed Effects model is the most appropriate design for the purpose of the provided data.") drop(var(u1) var(u3)) scalars("N_pop Individuals" "F F-Statistic" "p p-value" "à \hline \textbf{Hausman Test Results}" "chi_haus Hausman \chi^2" "p_haus Hausman p-value" "è \hline \textbf{Time Effect Test}" "F_time \texorpdfstring{F-value\textsubscript{time}}" "p_time \texorpdfstring{p-value\textsubscript{time}}") indicate("Time Effects = *.year") sfmt(%9.0fc %9.2fc %9.3fc %9.2fc %9.3fc) star(^+ 0.10 * 0.05 ** 0.01 *** 0.001) label

*PART 11: Offline vs. Online Fixed Effects

esttab offline_happy_fe online_happy_fe offline_happy_control_fe online_happy_control_fe using Online&OfflineFE.tex, replace booktabs b(3) se(2) refcat(1.lonely "\emph{Main Effects:}" intcntct "\emph{Engagement Effects:}" partvol "\emph{Controls:}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" intcntct "\hspace{0.25cm} Online Communication" partpartonline "\hspace{0.25cm} Online Engagement" 1.cohesion "\hspace{0.25cm} Low Civic Identification" 3.cohesion "\hspace{0.25cm} High Civic Identification" partpartoffline "\hspace{0.25cm} Offline Engagement" partvol "\hspace{0.25cm} Volunteering" marcohab "\hspace{0.25cm} Marriage Status" occ10STEM "\hspace{0.25cm} Online Workspace" attend "\hspace{0.25cm} Religious Activity" 2.year "Year") order(1.lonely 3.lonely intcntct 1.cohesion 3.cohesion partpartonline partpartoffline partvol marcohab occ10STEM attend 2.year) varwidth(30) modelwidth(5) legend nobaselevels noomitted unstack lines compress nogaps title("\textbf{Multinomial Logistic Model with Online and Offline Political Participation (Fixed Effects)} \strut"\label{tab2}) mgroups("Base" "Control", pattern(1 0 1 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) mtitles("Offline" "Online" "Offline" "Online") eqlabels("Happy" "Unhappy") nonumber addnote("\textbf{Note:} the controls used in the table were included to offset their effect on Loneliness and Happiness" "Volunteering and working with online tools were included to eliminate bias in online communication and political engagement." "Religious Attendance was included to control for civic identification with the residential community.") scalars("N_pop Individuals" "F F-Statistic" "p p-value") indicate("Time Effects = *.year") sfmt(%9.0fc %9.2fc %9.4fc) star(^+ 0.10 * 0.05 ** 0.01 *** 0.001) label

*PART 12: Survey Data Descriptives Random Effects

tabout lonely happy intcntct year using DescriptiveRE.tex if re_include == 1, replace style(tex) font(bold) twidth(12) c(col) bt svy f(3) npos(col) dropc(4) h1(Year) h2c(2 2 1) ptotal(none) nlab(Total) title(Table A1: Descriptive Statistics of Survey Participants (Random Effects)) fn(\textbf{Note:} Sample values are based on the total sample size after the controlled regression (N = 680). Cell numbers indicate the proportion of participants per category per year, while the \emph{total} column indicates the total number of participants within each category across both years. These variables are used as the main regressors in the model.)

tabout agecat race region4 attend4 using DemographicRE.tex if re_include == 1, replace style(tex) font(bold) twidth(10) c(col se) f(1p 2) mult(100) h1(Stratified Sample) bt oneway svy ptotal(none) noobs title(Table A2: Demographic Statistics of Survey Participants (Random Effects)) fn(\textbf{Note:} Sample values are based on the total sample size after the controlled regression (N = 680). These numbers reflect the participants that were used in the regression sample, and did not drop due to either missingness or lack of variance across survey years.)

tabout cohesion partpartoffline partpartonline occ10STEM year using TechRE.tex if re_include == 1, replace style(tex) font(bold) twidth(12) c(col) bt svy f(3) npos(col) dropc(4) h1(Year) h2c(2 2 1) ptotal(none) nlab(Total) title(Table A3: Behavioral Descriptives of Survey Participants (Random Effects)) fn(\textbf{Note:} Sample values are based on the total sample size after the controlled regression (N = 680). Cell numbers indicate the proportion of participants per category per year, while the \emph{total} column indicates the total number of participants within each category across both years. It is assumed that these variables will mediate the effect of our main regressors on happiness.)

*PART 13: Offline vs. Online Random Effects

esttab offline_happy_re online_happy_re offline_happy_control_re online_happy_control_re using Online&OfflineRE.tex, replace booktabs b(3) se(2) refcat(1.lonely "\emph{Main Effects:}" intcntct "\emph{Engagement Effects:}" partvol "\emph{Controls:}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" intcntct "\hspace{0.25cm} Online Communication" partpartonline "\hspace{0.25cm} Online Engagement" 1.cohesion "\hspace{0.25cm} Low Civic Identification" 3.cohesion "\hspace{0.25cm} High Civic Identification" partpartoffline "\hspace{0.25cm} Offline Engagement" partvol "\hspace{0.25cm} Volunteering" marcohab "\hspace{0.25cm} Marriage Status" occ10STEM "\hspace{0.25cm} Online Workspace" attend "\hspace{0.25cm} Religious Activity" 2.year "Year") order(1.lonely 3.lonely intcntct 1.cohesion 3.cohesion partpartonline partpartoffline partvol marcohab occ10STEM attend 2.year) varwidth(30) modelwidth(5) legend nobaselevels noomitted unstack lines compress nogaps title("\textbf{Multinomial Logistic Model with Online and Offline Political Participation (Random Effects)} \strut"\label{tab3}) mgroups("Base" "Control", pattern(1 0 1 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) mtitles("Offline" "Online" "Offline" "Online") eqlabels("Happy" "Unhappy") nonumber addnote("\textbf{Note:} the controls used in the table were included to offset their effect on Loneliness and Happiness" "Volunteering and working with online tools were included to eliminate bias in online communication and political engagement." "Religious Attendance was included to control for civic identification with the residential community.") scalars("N_pop Individuals" "F F-Statistic" "p p-value") indicate("Time Effects = *.year") drop(var(u1) var(u3)) sfmt(%9.0fc %9.2fc %9.4fc) star(^+ 0.10 * 0.05 ** 0.01 *** 0.001) label

*PART 14: Relative Risk Ratio Analysis

**FE
svy: xtmlogit happy ib2.lonely i.intcntct i.partpartoffline ib2.cohesion partvol marcohab occ10STEM attend i.year if fe_include == 1, fe rrr
estimates store rrr_offline_fe

svy: xtmlogit happy ib2.lonely i.intcntct i.partpartonline ib2.cohesion partvol marcohab occ10STEM attend i.year if fe_include == 1, fe rrr
estimates store rrr_online_fe

esttab rrr_offline_fe rrr_online_fe using RRRFE.tex, replace style(tex) eform booktabs varwidth(30) modelwidth(10) legend nobaselevels noomitted unstack lines compress nogaps b(3) se(2) noomitted drop(partvol marcohab occ10STEM attend 2.year) order(1.lonely 3.lonely 1.intcntct 1.partpartoffline 1.partpartonline 1.cohesion 3.cohesion) refcat(1.lonely "\textbf{Loneliness}" 1.intcntct "\textbf{Online Communication}" 1.partpartoffline "\textbf{Offline Engagement}" 1.partpartonline "\textbf{Online Engagement}" 1.cohesion "\textbf{Civic Identification}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" 1.intcntct "\hspace{0.25cm} High Online Presence" 1.partpartoffline "\hspace{0.25cm} Participated" 1.partpartonline "\hspace{0.25cm} Participated" 1.cohesion "\hspace{0.25cm} Low Identification" 3.cohesion "\hspace{0.25cm} High Identification") mtitles("Offline" "Online" "Offline" "Online") eqlabels("Happy" "Unhappy") title("\textbf{Relative Risk Ratios for Fixed Effects} \strut"\label{tab4}) nonumber addnote("\textbf{Note:} only statistically significant variables were included in this table." "Significance levels reflect the results of the non-transformed regression.") star(^+ 0.10 * 0.05 ** 0.01 *** 0.001) label


**RE
svy: xtmlogit happy ib2.lonely i.intcntct i.partpartoffline ib2.cohesion partvol i.marcohab occ10STEM attend i.year if re_include == 1, rrr
estimates store rrr_offline_re

svy: xtmlogit happy ib2.lonely i.intcntct i.partpartonline ib2.cohesion partvol i.marcohab occ10STEM attend i.year if re_include == 1, rrr
estimates store rrr_online_re

esttab rrr_offline_re rrr_online_re using RRRRE.tex, replace style(tex) eform booktabs varwidth(30) modelwidth(10) legend nobaselevels noomitted unstack lines compress nogaps b(3) se(2) noomitted drop(partvol occ10STEM attend 2.year var(u1) var(u3) _cons) order(1.lonely 3.lonely 1.intcntct 1.partpartoffline 1.partpartonline 1.cohesion 3.cohesion 2.marcohab 3.marcohab) refcat(1.lonely "\textbf{Loneliness}" 1.intcntct "\textbf{Online Communication}" 1.partpartoffline "\textbf{Offline Engagement}" 1.partpartonline "\textbf{Online Engagement}" 1.cohesion "\textbf{Civic Identification}" 2.marcohab "\textbf{Marriage and Cohabitation}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" 1.intcntct "\hspace{0.25cm} High Online Presence" 1.partpartoffline "\hspace{0.25cm} Participated" 1.partpartonline "\hspace{0.25cm} Participated" 1.cohesion "\hspace{0.25cm} Low Identification" 3.cohesion "\hspace{0.25cm} High Identification" 2.marcohab "\hspace{0.25cm} Not Married, Cohabitation" 3.marcohab "\hspace{0.25cm} Not Married, No Cohabitation" ) mtitles("Offline" "Online" "Offline" "Online") eqlabels("Happy" "Unhappy") title("\textbf{Relative Risk Ratios for Random Effects (Main Regressors)} \strut"\label{tab5}) nonumber addnote("\textbf{Note:} the cohabitation variable and any other statistically significant regressor was added to the table." "Significance levels reflect the results of the non-transformed regression.") star(^+ 0.10 * 0.05 ** 0.01 *** 0.001) label
...
svy: xtmlogit happy2 ib2.lonely intcntct partpartonline ib2.cohesion partvol marcohab occ10STEM attend i.year, fe
...
qui svy: xtmlogit happy2 ib2.lonely intcntct partpartonline ib2.cohesion partvol marcohab occ10STEM attend i.year if fe2_include == 1, fe
estimates store online_happy2_control_fe

qui svy: xtmlogit happy ib2.lonely intcntct partpartoffline ib2.cohesion partvol marcohab occ10STEM attend i.year if fe_include == 1, fe

qui svy: xtmlogit happy2 ib2.lonely intcntct partpartoffline ib2.cohesion partvol marcohab occ10STEM attend i.year if fe2_include==1, fe
estimates store offline_happy2_control_fe

esttab offline_happy_control_fe online_happy_control_fe offline_happy2_control_fe  online_happy2_control_fe using Online&Offline2FE.tex, replace booktabs b(3) se(2) refcat(1.lonely "\emph{Main Effects:}" intcntct "\emph{Engagement Effects:}" partvol "\emph{Controls:}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" intcntct "\hspace{0.25cm} Online Communication" partpartonline "\hspace{0.25cm} Online Engagement" 1.cohesion "\hspace{0.25cm} Low Identification" 3.cohesion "\hspace{0.25cm} High Identification" partpartoffline "\hspace{0.25cm} Offline Engagement" partvol "\hspace{0.25cm} Volunteering" marcohab "\hspace{0.25cm} Marriage Status" occ10STEM "\hspace{0.25cm} Online Workspace" attend "\hspace{0.25cm} Religious Activity" 2.year "Year") order(1.lonely 3.lonely intcntct 1.cohesion 3.cohesion partpartonline partpartoffline partvol marcohab occ10STEM attend 2.year) varwidth(30) modelwidth(5) legend nobaselevels noomitted unstack lines compress nogaps title("\textbf{Online and Offline Loneliness Fixed Effects, Before and After the 2020 Election} \strut"\label{tab8}) mgroups("Before Election" "After Election", pattern(1 0 1 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) mtitles("Offline" "Online" "Offline" "Online") eqlabels("Happy" "Unhappy") nonumber addnote("\textbf{Note:} some very interesting facts can be read from the table, mainly the changes in significance reported within." "As demonstrated by the correlation table, the small difference in observations does not imply a difference in individuals.") scalars("N_pop Individuals" "F F-Statistic" "p p-value") indicate("Time effects = *.year") sfmt(%9.0fc %9.2fc %9.4fc) star(^+ 0.10 * 0.05 ** 0.01 *** 0.001) label


**PART 15.5: Relative Risk Ratios

svy: xtmlogit happy2 ib2.lonely i.intcntct i.partpartonline ib2.cohesion partvol marcohab i.occ10STEM attend i.year if fe2_include == 1, fe rrr
estimate store rrr_online2_fe

svy: xtmlogit happy2 ib2.lonely i.intcntct i.partpartoffline ib2.cohesion partvol marcohab i.occ10STEM attend i.year if fe2_include == 1, fe rrr
estimate store rrr_offline2_fe

esttab rrr_offline2_fe rrr_online2_fe using RRRFE2.tex, replace style(tex) eform booktabs varwidth(30) modelwidth(10) legend nobaselevels noomitted unstack lines compress nogaps b(3) se(3) noomitted drop(partvol marcohab attend 2.year 1.occ10STEM) order(1.lonely 3.lonely 1.intcntct 1.partpartoffline 1.partpartonline 1.cohesion 3.cohesion) refcat(1.lonely "\textbf{Loneliness}" 1.intcntct "\textbf{Online Communication}" 1.partpartoffline "\textbf{Offline Engagement}" 1.partpartonline "\textbf{Online Engagement}" 1.cohesion "\textbf{Civic Identification}", nolabel) coeflabels(1.lonely "\hspace{0.25cm} Low Loneliness" 3.lonely "\hspace{0.25cm} High Loneliness" 1.intcntct "\hspace{0.25cm} High Online Presence" 1.partpartoffline "\hspace{0.25cm} Participated" 1.partpartonline "\hspace{0.25cm} Participated" 1.cohesion "\hspace{0.25cm} Low Civic Identification" 3.cohesion "\hspace{0.25cm} High Civic Identification") mtitles("Offline" "Online" "Offline" "Online") eqlabels("Happy" "Unhappy") title("\textbf{Relative Risk Ratios for Post-Election Fixed Effects} \strut"\label{tab9}) nonumber addnote("\textbf{Note:} only statistically significant variables were included in this table." "Significance levels reflect the results of the non-transformed regression.") star(^+ 0.10 * 0.05 ** 0.01 *** 0.001) label
